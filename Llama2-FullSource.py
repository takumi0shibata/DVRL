...
from utils.dvrl_utils import get_dev_sample, calc_qwk
...
def main(args):
    ...
    # Create dataset
    train_data = {'essay': np.concatenate([train_features, dev_features]).tolist(), 'labels': np.concatenate([y_train, y_dev]).tolist()}
